 ...
 * @author Renny Langat
 * 
 * This is a customised class that will used to get MediQuery Sizes.
 * When making use of it, make sure you call it in the build method of the initial route
 * that is loaded in the application. Checkout example in the SplashScreen
 * 
 */
